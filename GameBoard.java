public class GameBoard {
    ...
    public boolean checkWin() {
        ...
        // If there were more variable (X, O, etc.) I would have passed them through as
        // arguments instead to avoid copying the same solution over and over. However
        // since there are only two this way is okay too.
        boolean win = false;
    ...
    public int evaluate(int player) {
        ...
        int x1 = 0;
        int x2 = 0;
        int x3 = 100; // win state
        int o1 = 0;
        int o2 = 0;
        int o3 = 100; // win state
